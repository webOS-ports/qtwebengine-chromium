...
class CONTENT_EXPORT WebContentsDelegate {
 public:
  ...
  virtual void AddNewContents(WebContents* source,
      ...
      AddNewContents(source,std::move(new_contents),target_url,disposition,initial_rect,user_gesture,was_blocked,additional_features);
  }
  ...
  virtual void AddNewContents(WebContents* source,
                              ...
                              bool* was_blocked,
                              std::vector<base::string16> additional_features) {
      AddNewContents(source,std::move(new_contents),target_url,disposition,initial_rect,user_gesture,was_blocked);
  }
